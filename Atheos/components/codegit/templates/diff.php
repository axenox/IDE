...
foreach ($diffs as $i => $diff) {
	...
	echo "<h4 class=\"file-info\">File Name: $filename<span class=\"actions\" data-file=\"$element\" style=\"float:right;\"><button data-button=\"showOverview\">" . "Go Back" . "</button><button class=\"git_undo\" data-button=\"undo\">" . i18n("git_objects_actions_undo") . "</button></span></h4>";
	echo "<ul>";
